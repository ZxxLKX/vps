...
TIMES="10"
CHATID="1734868055"
KEY="7825447537:AAGuM0Xnl9P-tQdgiPydB19RUGuvQOGku0I"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To NATO STORE AUTOSCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}NATO STORE AUTOSCRIPT ® ${NC}${YELLOW}(${NC} ${green} NATO STORE AUTOSCRIPT ${NC}${YELLOW})${NC}"
echo -e " © Recode By NATO STORE AUTOSCRIPT ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/ZxxLKX/izin/main/ip| grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/ZxxLKX/izin/main/ip| grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/ZxxLKX/izin/main/ip| grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ZxxLKX/vps/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/ZxxLKX/izin/main/ip| grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/ZxxLKX/izin/main/ip| grep $MYIP | awk '{print $3}')
